...
```{r coleta}
# Data gathering
df <- read.csv('C:\\Users\\omartos\\Git\\DSA_Projetos\\DSA_Projetos\\Big Data Analytics com R e Microsoft Azure Machine Learning\\3.Prevendo Despesas Hospitalares\\despesas.csv', header = TRUE,sep = ',')
head(df)
```
